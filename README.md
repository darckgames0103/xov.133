...
CoreGui:SetCore("SendNotification", {
    -- Customizable
    Title = "This Gui is made by xovgaming",
    Text = "Enjoy! Using this script",
    Text = "Darkness Between me.",
    Duration = 5, -- Set the duration to how much you want this to stay
    -- More code in part 2
})
wait(1.9)
local Library = loadstring(game:HttpGet("https://pastebin.com/raw/vff1bQ9F"))()
local Window  = Library.CreateLib("Pop it trading v1.3.3 made by xovgaming", "DarkTheme")
...
Section:NewToggle("Auto Dupe RB Pop it {1.2Bil Cash Required}"  , "Dupe Pop It Rainbow", function(state)
    if state then
        ...
        Section:NewToggle("Auto Dupe RB Lolly {600M Cash Required}"  , "Dupe Lolly rainbow", function(state)
            if state then
                _G.on = true
...
local Section = Tab:NewSection("Added New Open and close Gui")
local Section = Tab:NewSection("Add More items to Dupe")
...
Frame.Position = UDim2.new(0, 0, 0.10, 0)
Frame.Size = UDim2.new(0, 72, 0, 27)
Frame.Active = true
...
Frame2.Position = UDim2.new(0, 0, 0.10, 0)
Frame2.Size = UDim2.new(0, 72, 0, 27)
Frame2.Active = true
Frame2.Draggable = true

TextButton2.Parent = Frame2
TextButton2.BackgroundColor3 = Color3.fromRGB(255,0,0)
TextButton2.Size = UDim2.new(0, 72, 0, 27)
